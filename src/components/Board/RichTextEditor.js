...
export default function RichTextEditor(props) {
    ...
    return <>
        <NavBar>
            <NavButton onClick={onTitleClick}><FormatTitle /></NavButton>
            <NavDivider />
            <NavButton onClick={onBoldClick}><FormatBold /></NavButton>
            <NavButton onClick={onItalicClick}><FormatItalic /></NavButton>
            <NavButton onClick={onUnderlineClick}><FormatUnderlined /></NavButton>
            <NavDivider />
